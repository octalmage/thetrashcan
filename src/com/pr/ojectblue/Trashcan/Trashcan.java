...
public class Trashcan extends JavaPlugin implements Listener {
	...
	public void onEnable() {
		...
		/*
		 * Creates the recipe to be trashcan shaped. o o o o o o o
		 */
		// TODO: Update to use new ShapedRecipe API with namespace. See: https://www.spigotmc.org/threads/1-12-shapedrecipe-namespacedkey.240616/
		ShapedRecipe RECIPE = new ShapedRecipe(new ItemStack(Material.CAULDRON_ITEM, 1)).shape("o o", "o o", "ooo")
				.setIngredient('o', Material.COBBLESTONE);
	...
	public void onPlayerInteract(PlayerInteractEvent event) {
		...
		if (event.getAction() == Action.RIGHT_CLICK_BLOCK) {
			// Check to see if they clicked a cauldron, and if they did make sure they
			// aren't holding a water bucket or a glass bottle.
			// Thanks to Algent for coming up with a simple way to make the Cauldron still
			// usable.
